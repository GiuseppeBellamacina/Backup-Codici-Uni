...
int main(){
  ...
  A a;
  cout<<endl; //l'output parte dal costruttore della superclasse a quello della sottoclasse
  B b;
  cout<<endl; //ogni classe figlio parte col costruttore della classe padre
  C c;
  cout<<endl;
  D d;
  cout<<endl;
