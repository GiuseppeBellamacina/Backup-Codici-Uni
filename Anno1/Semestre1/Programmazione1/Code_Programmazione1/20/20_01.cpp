...
int main(){
  ...
  char *p = "test"; // Per il C++11 il compilatore dara' un warning, perche' il letterale 
		    //viene rappresentato in una zona di memoria in sola lettura
  //p[2] = 'c'; //questa istruzione rappresenta un accesso non autorizzato a locazione di memoria 

  const char *p1 = "test"; // NO warning
