...
class A{
  ...
  public:
    /*A(){ //costruttore di default
      cout << "A()" << endl;
      x = 10;
    }*/ //o non si mette alcun costruttore di default e non si invoca una classe senza parametri, oppure se ne mette uno per classe
...
class B: public A{
  ...
  public:
    B(float v): y(v), A((int) (v+0.5)){ // lista di inizializzazione //è obbligatorio usare la lista di inizializzazione
      cout <<  "B(float)" << endl; 
      //y = v;
    }
