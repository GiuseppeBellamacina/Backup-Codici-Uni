...
// se la circonferenza non è dichiarata const, possono succedere cose strane...
/*
...
int main(){
	Cerchio c1 (10.0); // function form (pericolosa) è importante mettere lo spazio altrimenti sembra una dichiarazione di funzione
